...
#### Python:
```python
messages = get_chat_replay('https://www.youtube.com/watch?v=wXspodtIxYU', end_time=100)
```
...
#### Python:
```python
messages = get_chat_replay('https://www.youtube.com/watch?v=JIB3JbIIbPU', start_time=300, end_time=400)
```
...
#### Python:
```python
messages = get_chat_replay('https://www.youtube.com/watch?v=97w16cYskVI', end_time=100, message_type='superchat')
```
...
#### Python:
```python
messages = get_chat_replay('https://www.youtube.com/watch?v=wXspodtIxYU', start_time=100, end_time=200, message_type='all')
```
...
#### Python:
```python
messages = get_chat_replay('https://www.youtube.com/watch?v=wXspodtIxYU', end_time=100, chat_type='top')
```
...
#### Python:
```python
messages = get_chat_replay('https://www.youtube.com/watch?v=zVCs9Cug_qM')
```
...
#### Python:
```python
messages = get_chat_replay('https://www.twitch.tv/videos/449716115')
```
...
#### Python:
```python
messages = get_chat_replay('https://www.twitch.tv/videos/449716115', start_time=300, end_time=3000)
```
